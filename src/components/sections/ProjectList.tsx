...
const kategoriEtiketleri: Record<Category, string> = {
  frontend: "Ön yüz",
  fullstack: "Tam yığın",
  backend: "Arka uç",
};
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2 gap-2">
                  ...
                  {project.featured && (
                    <span className="bg-yellow-100 dark:bg-yellow-900/50 text-yellow-800 dark:text-yellow-200 text-xs px-2 py-0.5 rounded-full shrink-0">
                      Öne Çıkan
                    </span>
                  )}
                </div>
                ...
                <p className="text-xs text-gray-400">
                  {project.year}
                  {" \u00B7 "}
                  {kategoriEtiketleri[project.category]}
                </p>
              </div>
            </article>
          ))}
